...
public static void main(String[] args) throws IllegalArgumentException, IllegalAccessException {
   ...
   public static class Nodes {
      public static final Node SpatialObject = SRSGeo.SpatialObject.asNode();
      public static final Node Feature = SRSGeo.Feature.asNode();
      // simple features topological relations
      public static final Node st_area= SRSGeo.st_area.asNode();
      public static final Node st_azimuth= SRSGeo.st_azimuth.asNode();
      public static final Node st_band= SRSGeo.st_band.asNode();
      public static final Node st_bandmetadata= SRSGeo.st_bandmetadata.asNode();
      public static final Node st_bandnodatavalue= SRSGeo.st_bandnodatavalue.asNode();
      public static final Node st_bandpixeltype= SRSGeo.st_bandpixeltype.asNode();
      public static final Node st_centroid = SRSGeo.st_centroid.asNode();
      public static final Node st_clip = SRSGeo.st_clip.asNode();
      public static final Node st_closestPoint = SRSGeo.st_closestPoint.asNode();
      public static final Node st_concaveHull = SRSGeo.st_concaveHull.asNode();
      public static final Node st_delaunayTriangles = SRSGeo.st_delaunayTriangles.asNode();
      public static final Node st_dimension = SRSGeo.st_dimension.asNode();
      public static final Node st_endPoint = SRSGeo.st_endPoint.asNode();
      public static final Node st_envelope = SRSGeo.st_envelope.asNode();
      public static final Node st_flipCoordinates = SRSGeo.st_flipCoordinates.asNode();
      public static final Node st_geometryType = SRSGeo.st_geometryType.asNode();
      public static final Node st_geometryN = SRSGeo.st_geometryN.asNode();
      public static final Node st_hausdorffDistance = SRSGeo.st_hausdorffDistance.asNode();
      public static final Node st_isClosed = SRSGeo.st_isClosed.asNode();
      public static final Node st_isCollection = SRSGeo.st_isCollection.asNode();
      public static final Node st_isEmpty = SRSGeo.st_isEmpty.asNode();
      public static final Node st_isRing = SRSGeo.st_isRing.asNode();
      public static final Node st_isSimple = SRSGeo.st_isSimple.asNode();
      public static final Node st_isValid = SRSGeo.st_isValid.asNode();
      public static final Node st_isValidReason = SRSGeo.st_isValidReason.asNode();
      public static final Node st_Length = SRSGeo.st_Length.asNode();
      public static final Node st_Length2D = SRSGeo.st_Length2D.asNode();
      public static final Node st_m = SRSGeo.st_m.asNode();
      public static final Node st_makeLine = SRSGeo.st_makeLine.asNode();
      public static final Node st_makePoint = SRSGeo.st_makePoint.asNode();
      public static final Node st_makePointM = SRSGeo.st_makePointM.asNode();
      public static final Node st_makePolygon = SRSGeo.st_makePolygon.asNode();
      public static final Node st_mLineFromText = SRSGeo.st_mLineFromText.asNode();
      public static final Node st_mPointFromText = SRSGeo.st_mPointFromText.asNode();
      public static final Node st_mPolyFromText = SRSGeo.st_mPolyFromText.asNode();
      public static final Node st_minimumBoundingCircle = SRSGeo.st_minimumBoundingCircle.asNode();
      public static final Node st_nearestValue = SRSGeo.st_nearestValue.asNode();
      public static final Node st_numBands = SRSGeo.st_numBands.asNode();
      public static final Node st_numGeometries = SRSGeo.st_numGeometries.asNode();
      public static final Node st_numPoints = SRSGeo.st_numPoints.asNode();
      public static final Node st_nPoints = SRSGeo.st_nPoints.asNode();  
      public static final Node st_offsetCurve = SRSGeo.st_offsetCurve.asNode();
      public static final Node st_perimeter = SRSGeo.st_perimeter.asNode();
      public static final Node st_perimeter2D = SRSGeo.st_perimeter2D.asNode();
      public static final Node st_pixelAsPoint = SRSGeo.st_pixelAsPoint.asNode();
      public static final Node st_pixelHeight = SRSGeo.st_pixelHeight.asNode();
      public static final Node st_pointN = SRSGeo.st_pointN.asNode();
      public static final Node st_rast_Contains = SRSGeo.st_rast_Contains.asNode();
      public static final Node st_rast_Covers = SRSGeo.st_rast_Covers.asNode();
      public static final Node st_rast_CoveredBy = SRSGeo.st_rast_CoveredBy.asNode();
      public static final Node st_rast_Disjoint = SRSGeo.st_rast_Disjoint.asNode();
      public static final Node st_rast_isEmpty = SRSGeo.st_rast_isEmpty.asNode();
      public static final Node st_rast_Overlaps = SRSGeo.st_rast_Overlaps.asNode();
      public static final Node st_rast_srid = SRSGeo.st_rast_srid.asNode();
      public static final Node st_rast_Touches = SRSGeo.st_rast_Touches.asNode();
      public static final Node st_rast_Within = SRSGeo.st_rast_Within.asNode();
      public static final Node st_rasterToWorldCoord = SRSGeo.st_rasterToWorldCoord.asNode();
      public static final Node st_rasterToWorldCoordX = SRSGeo.st_rasterToWorldCoordX.asNode();
      public static final Node st_rasterToWorldCoordY = SRSGeo.st_rasterToWorldCoordY.asNode();
      public static final Node st_reverse = SRSGeo.st_reverse.asNode();
      public static final Node st_rotate = SRSGeo.st_rotate.asNode();
      public static final Node st_scale = SRSGeo.st_scale.asNode();
      public static final Node st_segmentize = SRSGeo.st_segmentize.asNode();
      public static final Node st_setPoint = SRSGeo.st_setPoint.asNode();
      public static final Node st_simplify = SRSGeo.st_simplify.asNode();
      public static final Node st_simplifyPreserveTopology = SRSGeo.st_simplifyPreserveTopology.asNode();
      public static final Node st_snap = SRSGeo.st_snap.asNode();
      public static final Node st_split = SRSGeo.st_split.asNode();
      public static final Node st_srid = SRSGeo.st_srid.asNode();
      public static final Node st_startPoint = SRSGeo.st_startPoint.asNode();
      public static final Node st_summary = SRSGeo.st_summary.asNode();
      public static final Node st_summaryStats = SRSGeo.st_summaryStats.asNode();
      public static final Node st_swapOrdinates = SRSGeo.st_swapOrdinates.asNode();
      public static final Node st_transform = SRSGeo.st_transform.asNode();
      public static final Node st_translate = SRSGeo.st_translate.asNode();
      public static final Node st_transscale = SRSGeo.st_transscale.asNode();
      public static final Node st_unaryUnion = SRSGeo.st_unaryUnion.asNode();
      public static final Node st_upperLeftX = SRSGeo.st_upperLeftX.asNode();
      public static final Node st_upperLeftY = SRSGeo.st_upperLeftY.asNode();
      public static final Node st_value = SRSGeo.st_value.asNode();
      public static final Node st_width = SRSGeo.st_width.asNode();
      public static final Node st_worldToRasterCoord = SRSGeo.st_worldToRasterCoord.asNode();
      public static final Node st_worldToRasterCoordX = SRSGeo.st_worldToRasterCoordX.asNode();
      public static final Node st_worldToRasterCoordY = SRSGeo.st_worldToRasterCoordY.asNode();
      public static final Node st_x = SRSGeo.st_x.asNode();
      public static final Node st_xMin = SRSGeo.st_xMin.asNode();
      public static final Node st_xMax = SRSGeo.st_xMax.asNode();
      public static final Node st_y = SRSGeo.st_y.asNode();
      public static final Node st_yMin = SRSGeo.st_yMin.asNode();
      public static final Node st_yMax = SRSGeo.st_yMax.asNode();
      public static final Node st_z = SRSGeo.st_z.asNode();
