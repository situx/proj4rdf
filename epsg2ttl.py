...
ttl.add("geo:area_of_use rdfs:range geo:AreaOfUse .\n")
ttl.add("geo:area_of_use rdfs:domain geo:CoordinateConcatenatedOperation, geo:CoordinateConversionOperation, geo:CoordinateTransformationOperation, geo:OtherCoordinateOperation, geo:CoordinateOperation .\n")
