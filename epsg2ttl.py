...
ttl.add("geocrs:CartesianCoordinateSystem rdfs:subClassOf geocrs:CoordinateSystem .\n")
...
ttl.add("geocrs:GeographicCRS rdfs:subClassOf geocrs:CRS .\n")
...
ttl.add("geocrs:GeodeticCRS rdfs:subClassOf geocrs:CRS .\n")
...
ttl.add("geocrs:CoordinateTransformation rdfs:subClassOf geocrs:CRS .\n")
...
ttl.add("geocrs:TemporalCRS rdfs:subClassOf geocrs:CRS .\n")
...
ttl.add("geocrs:ParametricCRS rdfs:subClassOf geocrs:CRS .\n")
...
ttl.add("geocrs:DerivedGeographicCRS rdfs:subClassOf geocrs:GeodeticCRS .\n")
...
ttl.add("geocrs:EngineeringCRS rdfs:subClassOf geocrs:CRS .\n")
...
ttl.add("geocrs:VerticalCRS rdfs:subClassOf geocrs:CRS .\n")
...
ttl.add("geocrs:SphericCRS rdfs:subClassOf geocrs:CRS .\n")
ttl.add("geocrs:SphericCRS rdf:type owl:Class .\n")
ttl.add("geocrs:SphericCRS rdfs:label \"Spheric coordinate reference system\"@en .\n")
ttl.add("geocrs:SphericCRS skos:definition \"three-dimensional coordinate system in Euclidean space in which position is specified by one distance coordinate and two angular coordinates\"@en .\n")
ttl.add("geocrs:SphericCRS rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
