...
ttl.add("geo:isProj4 rdfs:range xsd:string .\n")
ttl.add("geo:isProj4 rdfs:domain geo:CRS .\n")
...
for line in f: 
	if i%2==0:
		...
		if curcrs.coordinate_operation!=None:
			...
			ttl.add("geoepsg:"+str(coordoperationid)+" rdfs:label \""+curcrs.coordinate_operation.method_name+"\"@en . \n")
