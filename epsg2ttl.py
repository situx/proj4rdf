...
ttl.add("geocrs:column-positive rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttl.add("geocrs:column-positive rdfs:label \"column positive\"@en .\n")
ttl.add("geocrs:column-positive rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttl.add("geocrs:column-positive skos:definition \"axis positive direction is towards higher pixel column\"@en .\n")
ttl.add("geocrs:column-negative rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttl.add("geocrs:column-negative rdfs:label \"column negative\"@en .\n")
ttl.add("geocrs:column-negative rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttl.add("geocrs:column-negative skos:definition \"axis positive direction is towards lower pixel column\"@en .\n")
ttl.add("geocrs:row-positive rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttl.add("geocrs:row-positive rdfs:label \"row positive\"@en .\n")
ttl.add("geocrs:row-positive rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttl.add("geocrs:row-positive skos:definition \"axis positive direction is towards higher pixel row\"@en .\n")
ttl.add("geocrs:row-negative rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttl.add("geocrs:row-negative rdfs:label \"row negative\"@en .\n")
ttl.add("geocrs:row-negative rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttl.add("geocrs:row-negative skos:definition \"axis positive direction is towards lower pixel row\"@en .\n")
