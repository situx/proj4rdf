...
spheroids["Struve 1860"]="geo:Struve1860"
...
for line in f: 
	if i%2==0:
		...
		ttl.add("geoepsg:"+epsgcode+" geo:type \""+str(curcrs.type_name)+"\"^^xsd:string . \n")
		...
		if curcrs.coordinate_operation!=None:
			...
			for par in curcrs.coordinate_operation.params:
				ttl.add("geoepsg:"+str(coordoperationid)+" geo:param \""+str(par.name)+"\"^^xsd:string . \n")                
