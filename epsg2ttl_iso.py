...
ttlprojectionvocab.add("geocrs:ApianIIProjection rdfs:subClassOf geocrs:PseudocylindricProjection .\n")
...
ttlprojectionvocab.add("geocrs:FaheyProjection rdfs:subClassOf geocrs:PseudocylindricProjection .\n")
