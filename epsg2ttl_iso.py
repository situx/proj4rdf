...
ttlnoniso.add("geocrs:Projection rdfs:subClassOf geocrs:Conversion .\n")
...
ttl.add("geocrs:ConversionOperation rdf:type owl:Class .\n")
ttl.add("geocrs:ConversionOperation rdfs:subClassOf geocrs:SingleOperation .\n")
ttl.add("geocrs:ConversionOperation rdfs:label \"coordinate conversion operation\"@en .\n")
ttl.add("geocrs:ConversionOperation skos:definition \"Coordinate operation in which both coordinate reference systems are based on the same datum\"@en .\n")
ttl.add("geocrs:ConversionOperation rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
