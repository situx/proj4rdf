...
ttlhead+="@prefix geoepsg: <https://situx.github.io/proj4rdf/def/crs/EPSG/0/> .\n"
ttlhead+="@prefix geo: <http://www.opengis.net/ont/geosparql#> .\n"
ttlhead+="@prefix geocrs: <http://purl.org/srs/> .\n"
ttlhead+="@prefix geocrsdatum: <http://purl.org/srs/datum/> .\n"
ttlhead+="@prefix geocrsisbody: <http://purl.org/srs/isbody/> .\n"
ttlhead+="@prefix geocrsgrid: <http://purl.org/srs/grid/> .\n"
ttlhead+="@prefix geocrsproj: <http://purl.org/srs/proj/> .\n"
ttlhead+="@prefix geocrsaxis: <http://purl.org/srs/cs/axis/> .\n"
ttlhead+="@prefix geocrsgeod: <http://purl.org/srs/geod/> .\n"
ttlhead+="@prefix geocrsaou: <http://purl.org/srs/areaofuse/> .\n"
ttlhead+="@prefix geocrsmeridian: <http://purl.org/srs/primeMeridian/> .\n"
ttlhead+="@prefix geocrsoperation: <http://purl.org/srs/operation/> .\n"
ttlhead+="@prefix geocs: <http://purl.org/srs/cs/> .\n"
