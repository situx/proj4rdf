...
ttl.add("geocrs:LinearCoordinateSystem rdfs:subClassOf geocrs:1DCS .\n")
...
ttl.add("geocrs:GridCoordinateSystem rdfs:subClassOf geocrs:CS .\n")
...
ttl.add("geocrs:HexagonalCoordinateSystem rdfs:subClassOf geocrs:GridCS .\n")
...
ttl.add("geocrs:ObliqueCoordinateSystem rdfs:subClassOf geocrs:AffineCS .\n")
...
ttl.add("geocrs:CelestialCoordinateSystem rdfs:subClassOf geocrs:CS .\n")
...
ttl.add("geocrs:EngineeringCoordinateSystem rdfs:subClassOf geocrs:CS .\n")
...
ttl.add("geocrs:GeodeticCoordinateSystem rdfs:subClassOf geocrs:CS .\n")
...
ttl.add("geocrs:EllipsoidalCoordinateSystem rdfs:subClassOf geocrs:OrthogonalCS .\n")
...
ttl.add("geocrs:HorizontalCoordinateSystem rdfs:subClassOf geocrs:CelestialCS .\n")
...
ttl.add("geocrs:EquatorialCoordinateSystem rdfs:subClassOf geocrs:CelestialCS .\n")
...
ttl.add("geocrs:EclipticCoordinateSystem rdfs:subClassOf geocrs:CelestialCS .\n")
...
ttl.add("geocrs:SuperGalacticCoordinateSystem rdfs:subClassOf geocrs:CelestialCoordinateSystem, geocrs:3DCS .\n")
...
ttl.add("geocrs:PerspectiveProjection rdf:type owl:Class .\n")
ttl.add("geocrs:PerspectiveProjection rdfs:label \"perspective projection\"@en .\n")
ttl.add("geocrs:PerspectiveProjection rdfs:subClassOf geocrs:Projection .\n")
...
ttl.add("geocrs:EquidistantProjection skos:definition \"Projection in which all points on the map exhibit proportionally correct distances from the center point\"@en .\n")
...
ttl.add("geocrs:ConformalProjection skos:definition \"A projection in which every angle between two curves that crosss each other on a celestical boday is preserved in the image of the projection\"@en .\n")
ttl.add("geocrs:ConformalProjection rdfs:subClassOf geocrs:Projection .\n")
ttl.add("geocrs:SRSRegistry rdf:type owl:Class .\n")
ttl.add("geocrs:SRSRegistry rdfs:label \"srs registry\"@en .\n")
ttl.add("geocrs:SRSRegistry skos:definition \"A rdf-enabled registry for SRS definitions\"@en .\n")
ttl.add("geocrs:AzimuthalProjection rdf:type owl:Class .\n")
ttl.add("geocrs:AzimuthalProjection rdfs:label \"azimuthal projection\"@en .\n")
ttl.add("geocrs:AzimuthalProjection skos:definition \"A projection with the property that directions from a central point are preserved\"@en .\n")
ttl.add("geocrs:AzimuthalProjection rdfs:subClassOf geocrs:Projection .\n")
ttl.add("geocrs:RetroazimuthalProjection rdf:type owl:Class .\n")
ttl.add("geocrs:RetroazimuthalProjection rdfs:label \"retroazimuthal projection\"@en .\n")
ttl.add("geocrs:RetroazimuthalProjection rdfs:subClassOf geocrs:Projection .\n")
ttl.add("geocrs:CollignonProjection rdf:type owl:Class .\n")
ttl.add("geocrs:CollignonProjection rdfs:label \"collignon projection\"@en .\n")
ttl.add("geocrs:CollignonProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:GaussKruegerProjection rdf:type owl:Class .\n")
ttl.add("geocrs:GaussKruegerProjection rdfs:label \"gauss-krüger projection\"@en .\n")
ttl.add("geocrs:GaussKruegerProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:ConformalProjection .\n")
ttl.add("geocrs:AuthaGraphProjection rdf:type owl:Class .\n")
ttl.add("geocrs:AuthaGraphProjection rdfs:label \"autha graph projection\"@en .\n")
ttl.add("geocrs:AuthaGraphProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:ToblerHyperelliptical rdf:type owl:Class .\n")
ttl.add("geocrs:ToblerHyperelliptical rdfs:label \"tobler hyperelliptical projection\"@en .\n")
ttl.add("geocrs:ToblerHyperelliptical rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:CahillKeyesProjection rdf:type owl:Class .\n")
ttl.add("geocrs:CahillKeyesProjection rdfs:label \"cahill-keyes projection\"@en .\n")
ttl.add("geocrs:CahillKeyesProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:CentralCylindricalProjection rdf:type owl:Class .\n")
ttl.add("geocrs:CentralCylindricalProjection rdfs:label \"central cylindrical projection\"@en .\n")
ttl.add("geocrs:CentralCylindricalProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:PerspectiveProjection .\n")
ttl.add("geocrs:LittrowProjection rdf:type owl:Class .\n")
ttl.add("geocrs:LittrowProjection rdfs:label \"littrow projection\"@en .\n")
ttl.add("geocrs:LittrowProjection rdfs:subClassOf geocrs:RetroazimuthalProjection, geocrs:ConformalProjection .\n")
ttl.add("geocrs:QuarticAuthalicProjection rdf:type owl:Class .\n")
ttl.add("geocrs:QuarticAuthalicProjection rdfs:label \"quartic authalic projection\"@en .\n")
ttl.add("geocrs:QuarticAuthalicProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:CraigRetroazimuthalProjection rdf:type owl:Class .\n")
ttl.add("geocrs:CraigRetroazimuthalProjection rdfs:label \"craig retroazimuthal projection\"@en .\n")
ttl.add("geocrs:CraigRetroazimuthalProjection rdfs:subClassOf geocrs:RetroazimuthalProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:PeirceQuincuncialProjection rdf:type owl:Class .\n")
ttl.add("geocrs:PeirceQuincuncialProjection rdfs:label \"peirce quincuncial projection\"@en .\n")
ttl.add("geocrs:PeirceQuincuncialProjection rdfs:subClassOf geocrs:ConformalProjection .\n")
ttl.add("geocrs:VerticalPerspectiveProjection rdf:type owl:Class .\n")
ttl.add("geocrs:VerticalPerspectiveProjection rdfs:label \"vertical perspective projection\"@en .\n")
ttl.add("geocrs:VerticalPerspectiveProjection rdfs:subClassOf geocrs:AzimuthalProjection, geocrs:PerspectiveProjection .\n")
ttl.add("geocrs:NicolosiGlobularProjection rdf:type owl:Class .\n")
ttl.add("geocrs:NicolosiGlobularProjection rdfs:label \"nicolosi globular projection\"@en .\n")
ttl.add("geocrs:NicolosiGlobularProjection rdfs:subClassOf geocrs:PseudoConicalProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:BehrmannProjection rdf:type owl:Class .\n")
ttl.add("geocrs:BehrmannProjection rdfs:label \"behrmann projection\"@en .\n")
ttl.add("geocrs:BehrmannProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:HoboDyerProjection rdf:type owl:Class .\n")
ttl.add("geocrs:HoboDyerProjection rdfs:label \"hobo-dyer projection\"@en .\n")
ttl.add("geocrs:HoboDyerProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:GallPetersProjection rdf:type owl:Class .\n")
ttl.add("geocrs:GallPetersProjection rdfs:label \"gall-peters projection\"@en .\n")
ttl.add("geocrs:GallPetersProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:GallStereographicProjection rdf:type owl:Class .\n")
ttl.add("geocrs:GallStereographicProjection rdfs:label \"gall stereographic projection\"@en .\n")
ttl.add("geocrs:GallStereographicProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:Strebe1995Projection rdf:type owl:Class .\n")
ttl.add("geocrs:Strebe1995Projection rdfs:label \"strebe 1995 projection\"@en .\n")
ttl.add("geocrs:Strebe1995Projection rdfs:subClassOf geocrs:PseudoAzimuthalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:WatermanButterflyProjection rdf:type owl:Class .\n")
ttl.add("geocrs:WatermanButterflyProjection rdfs:label \"waterman butterfly projection\"@en .\n")
ttl.add("geocrs:WatermanButterflyProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:QuadrilateralizedSphericalCubeProjection rdf:type owl:Class .\n")
ttl.add("geocrs:QuadrilateralizedSphericalCubeProjection rdfs:label \"quadrilateralized spherical cube projection\"@en .\n")
ttl.add("geocrs:QuadrilateralizedSphericalCubeProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:BonneProjection rdf:type owl:Class .\n")
ttl.add("geocrs:BonneProjection rdfs:label \"bonne projection\"@en .\n")
ttl.add("geocrs:BonneProjection rdfs:subClassOf geocrs:PseudoConicalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:ArmadilloProjection rdf:type owl:Class .\n")
ttl.add("geocrs:ArmadilloProjection rdfs:label \"armadillo projection\"@en .\n")
ttl.add("geocrs:ArmadilloProjection rdfs:subClassOf geocrs:CompromiseProjection .\n")
ttl.add("geocrs:GS50Projection rdf:type owl:Class .\n")
ttl.add("geocrs:GS50Projection rdfs:label \"gs50 projection\"@en .\n")
ttl.add("geocrs:GS50Projection rdfs:subClassOf geocrs:ConformalProjection .\n")
ttl.add("geocrs:Eckert2Projection rdf:type owl:Class .\n")
ttl.add("geocrs:Eckert2Projection rdfs:label \"Eckert II projection\"@en .\n")
ttl.add("geocrs:Eckert2Projection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:Eckert4Projection rdf:type owl:Class .\n")
ttl.add("geocrs:Eckert4Projection rdfs:label \"Eckert IV projection\"@en .\n")
ttl.add("geocrs:Eckert4Projection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:Eckert6Projection rdf:type owl:Class .\n")
ttl.add("geocrs:Eckert6Projection rdfs:label \"Eckert VI projection\"@en .\n")
ttl.add("geocrs:Eckert6Projection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:Kavrayskiy7Projection rdf:type owl:Class .\n")
ttl.add("geocrs:Kavrayskiy7Projection rdfs:label \"Kavrayskiy VII projection\"@en .\n")
ttl.add("geocrs:Kavrayskiy7Projection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:GuyouProjection rdf:type owl:Class .\n")
ttl.add("geocrs:GuyouProjection rdfs:label \"guyou projection\"@en .\n")
ttl.add("geocrs:GuyouProjection rdfs:subClassOf geocrs:ConformalProjection .\n")
ttl.add("geocrs:RoussilheProjection rdf:type owl:Class .\n")
ttl.add("geocrs:RoussilheProjection rdfs:label \"roussilhe projection\"@en .\n")
ttl.add("geocrs:RoussilheProjection rdfs:subClassOf geocrs:ObliqueProjection, geocrs:StereographicProjection .\n")
ttl.add("geocrs:LeeProjection rdf:type owl:Class .\n")
ttl.add("geocrs:LeeProjection rdfs:label \"lee projection\"@en .\n")
ttl.add("geocrs:LeeProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:ConformalProjection .\n")
ttl.add("geocrs:AdamsProjection rdf:type owl:Class .\n")
ttl.add("geocrs:AdamsProjection rdfs:label \"adams projection\"@en .\n")
ttl.add("geocrs:AdamsProjection rdfs:subClassOf geocrs:ConformalProjection .\n")
ttl.add("geocrs:OrteliusOvalProjection rdf:type owl:Class .\n")
ttl.add("geocrs:OrteliusOvalProjection rdfs:label \"ortelius oval projection\"@en .\n")
ttl.add("geocrs:OrteliusOvalProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:GoodeHomolosineProjection rdf:type owl:Class .\n")
ttl.add("geocrs:GoodeHomolosineProjection rdfs:label \"goode homolosine projection\"@en .\n")
ttl.add("geocrs:GoodeHomolosineProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:HEALPixProjection rdf:type owl:Class .\n")
ttl.add("geocrs:HEALPixProjection rdfs:label \"HEALPix projection\"@en .\n")
ttl.add("geocrs:HEALPixProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:BoggsEumorphicProjection rdf:type owl:Class .\n")
...
ttl.add("geocrs:TheTimesProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:DymaxionProjection rdf:type owl:Class .\n")
ttl.add("geocrs:DymaxionProjection rdfs:label \"dymaxion projection\"@en .\n")
ttl.add("geocrs:DymaxionProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:MollweideProjection rdf:type owl:Class .\n")
ttl.add("geocrs:MollweideProjection rdfs:label \"mollweide projection\"@en .\n")
ttl.add("geocrs:MollweideProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:MyrahedalProjection rdf:type owl:Class .\n")
ttl.add("geocrs:MyrahedalProjection rdfs:label \"myrahedal projection\"@en .\n")
ttl.add("geocrs:MyrahedalProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:WagnerVIIProjection rdf:type owl:Class .\n")
ttl.add("geocrs:WagnerVIIProjection rdfs:label \"wagner VII projection\"@en .\n")
ttl.add("geocrs:WagnerVIIProjection rdfs:subClassOf geocrs:PseudoAzimuthalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:AtlantisProjection rdf:type owl:Class .\n")
ttl.add("geocrs:AtlantisProjection rdfs:label \"atlantis projection\"@en .\n")
ttl.add("geocrs:AtlantisProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:BertinProjection rdf:type owl:Class .\n")
ttl.add("geocrs:BertinProjection rdfs:label \"bertin projection\"@en .\n")
ttl.add("geocrs:BertinProjection rdfs:subClassOf geocrs:CompromiseProjection .\n")
ttl.add("geocrs:WernerProjection rdf:type owl:Class .\n")
ttl.add("geocrs:WernerProjection rdfs:label \"werner projection\"@en .\n")
ttl.add("geocrs:WernerProjection rdfs:subClassOf geocrs:PseudoConicalProjection, geocrs:EqualAreaProjection, geocrs:EquidistantProjection .\n")
ttl.add("geocrs:EquirectangularProjection rdf:type owl:Class .\n")
ttl.add("geocrs:EquirectangularProjection rdfs:label \"equirectangular projection\"@en .\n")
ttl.add("geocrs:EquirectangularProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:EquidistantProjection .\n")
ttl.add("geocrs:ConicalProjection rdf:type owl:Class .\n")
ttl.add("geocrs:ConicalProjection rdfs:label \"conical projection\"@en .\n")
...
ttl.add("geocrs:ObliqueMercatorProjection rdfs:subClassOf geocrs:MercatorProjection, geocrs:CylindricalProjection, geocrs:ObliqueProjection .\n")
ttl.add("geocrs:SpaceObliqueMercatorProjection rdf:type owl:Class .\n")
ttl.add("geocrs:SpaceObliqueMercatorProjection rdfs:label \"space oblique mercator projection\"@en .\n")
ttl.add("geocrs:SpaceObliqueMercatorProjection rdfs:subClassOf geocrs:ObliqueMercatorProjection .\n")
...
ttl.add("geocrs:PseudoCylindricalProjection rdf:type owl:Class .\n")
ttl.add("geocrs:PseudoCylindricalProjection rdfs:label \"pseudo-cylindrical projection\"@en .\n")
ttl.add("geocrs:PseudoCylindricalProjection rdfs:subClassOf geocrs:Projection .\n")
ttl.add("geocrs:PseudoAzimuthalProjection rdf:type owl:Class .\n")
ttl.add("geocrs:PseudoAzimuthalProjection rdfs:label \"pseudo-azimuthal projection\"@en .\n")
ttl.add("geocrs:PseudoAzimuthalProjection rdfs:subClassOf geocrs:Projection .\n")
ttl.add("geocrs:CylindricalProjection rdf:type owl:Class .\n")
ttl.add("geocrs:CylindricalProjection rdfs:label \"cylindrical projection\"@en .\n")
ttl.add("geocrs:CylindricalProjection rdfs:subClassOf geocrs:Projection .\n")
...
ttl.add("geocrs:AmericanPolyconicProjection rdf:type owl:Class .\n")
ttl.add("geocrs:AmericanPolyconicProjection  rdfs:label \"american polyconic projection\"@en .\n")
ttl.add("geocrs:AmericanPolyconicProjection  rdfs:subClassOf geocrs:PseudoConicalProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:RectangularPolyconicProjection rdf:type owl:Class .\n")
ttl.add("geocrs:RectangularPolyconicProjection  rdfs:label \"rectangular polyconic projection\"@en .\n")
ttl.add("geocrs:RectangularPolyconicProjection  rdfs:subClassOf geocrs:PseudoConicalProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:ObliqueProjection rdf:type owl:Class .\n")
ttl.add("geocrs:ObliqueProjection rdfs:label \"oblique projection\"@en .\n")
ttl.add("geocrs:ObliqueProjection skos:definition \"a projection made by parallel lines drawn from every point of a figure and meeting the plane of projection obliquely\"@en .\n")
ttl.add("geocrs:ObliqueProjection rdfs:subClassOf geocrs:Projection .\n")
ttl.add("geocrs:LoximuthalProjection rdf:type owl:Class .\n")
ttl.add("geocrs:LoximuthalProjection rdfs:label \"loximuthal projection\"@en .\n")
ttl.add("geocrs:LoximuthalProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:CompromiseProjection .\n")
...
ttl.add("geocrs:AlbersEqualAreaProjection skos:definition \"a conic, equal area map projection that uses two standard parallels\"@en .\n")
ttl.add("geocrs:AlbersEqualAreaProjection rdfs:subClassOf geocrs:EqualAreaProjection, geocrs:ConicalProjection .\n")
ttl.add("geocrs:WinkelTripelProjection rdf:type owl:Class .\n")
ttl.add("geocrs:WinkelTripelProjection rdfs:label \"winkel tripel projection\"@en .\n")
ttl.add("geocrs:WinkelTripelProjection rdfs:subClassOf geocrs:PseudoAzimuthalProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:OctantProjection rdf:type owl:Class .\n")
ttl.add("geocrs:OctantProjection rdfs:label \"octant projection\"@en .\n")
ttl.add("geocrs:OctantProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:CompromiseProjection .\n")
...
ttl.add("geocrs:EqualEarthProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:NaturalEarthProjection rdf:type owl:Class .\n")
ttl.add("geocrs:NaturalEarthProjection rdfs:label \"natural earth projection\"@en .\n")
ttl.add("geocrs:NaturalEarthProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:CompromiseProjection .\n")
...
ttl.add("geocrs:OrthographicProjection rdfs:subClassOf geocrs:AzimuthalProjection, geocrs:PerspectiveProjection .\n")
...
ttl.add("geocrs:CassiniProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:EquidistantProjection .\n")
ttl.add("geocrs:AitoffProjection rdf:type owl:Class .\n")
ttl.add("geocrs:AitoffProjection rdfs:label \"aitoff projection\"@en .\n")
ttl.add("geocrs:AitoffProjection rdfs:subClassOf geocrs:PseudoAzimuthalProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:CompromiseProjection rdf:type owl:Class .\n")
ttl.add("geocrs:CompromiseProjection rdfs:label \"compromise projection\"@en .\n")
ttl.add("geocrs:CompromiseProjection rdfs:subClassOf geocrs:Projection .\n")
ttl.add("geocrs:HammerProjection rdf:type owl:Class .\n")
ttl.add("geocrs:HammerProjection rdfs:label \"hammer projection\"@en .\n")
ttl.add("geocrs:HammerProjection rdfs:subClassOf geocrs:PseudoAzimuthalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:TwoPointEquidistantProjection rdf:type owl:Class .\n")
ttl.add("geocrs:TwoPointEquidistantProjection rdfs:label \"two-point equidistance projection\"@en .\n")
ttl.add("geocrs:TwoPointEquidistantProjection rdfs:subClassOf geocrs:AzimuthalProjection, geocrs:EquidistantProjection .\n")
ttl.add("geocrs:SinusoidalProjection rdf:type owl:Class .\n")
ttl.add("geocrs:SinusoidalProjection rdfs:label \"sinusoidal projection\"@en .\n")
ttl.add("geocrs:SinusoidalProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection, geocrs:EquidistantProjection .\n")
...
ttl.add("geocrs:StereographicProjection rdfs:subClassOf geocrs:ConformalProjection, geocrs:AzimuthalProjection .\n")
...
ttl.add("geocrs:ObliqueStereographicProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:ObliqueProjection .\n")
ttl.add("geocrs:MercatorProjection rdf:type owl:Class .\n")
ttl.add("geocrs:MercatorProjection rdfs:label \"mercator projection\"@en .\n")
ttl.add("geocrs:MercatorProjection rdfs:subClassOf geocrs:ConformalProjection, geocrs:CylindricalProjection .\n")
ttl.add("geocrs:BottomleyProjection rdf:type owl:Class .\n")
ttl.add("geocrs:BottomleyProjection rdfs:label \"bottomley projection\"@en .\n")
ttl.add("geocrs:BottomleyProjection rdfs:subClassOf geocrs:PseudoConicalProjection, geocrs:EqualAreaProjection .\n")
ttl.add("geocrs:VanDerGrintenProjection rdf:type owl:Class .\n")
ttl.add("geocrs:VanDerGrintenProjection rdfs:label \"van der grinten projection\"@en .\n")
ttl.add("geocrs:VanDerGrintenProjection rdfs:subClassOf geocrs:CompromiseProjection .\n")
ttl.add("geocrs:RobinsonProjection rdf:type owl:Class .\n")
ttl.add("geocrs:RobinsonProjection rdfs:label \"robinson projection\"@en .\n")
ttl.add("geocrs:RobinsonProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:WebMercatorProjection rdf:type owl:Class .\n")
ttl.add("geocrs:WebMercatorProjection rdfs:label \"web mercator projection\"@en .\n")
ttl.add("geocrs:WebMercatorProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:CompromiseProjection .\n")
ttl.add("geocrs:MillerProjection rdf:type owl:Class .\n")
ttl.add("geocrs:MillerProjection rdfs:label \"miller projection\"@en .\n")
ttl.add("geocrs:MillerProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:CompromiseProjection .\n")
...
ttl.add("geocrs:EquidistantCylindricalProjection rdf:type owl:Class .\n")
ttl.add("geocrs:EquidistantCylindricalProjection rdfs:label \"equidistant cylindrical projection\"@en .\n")
ttl.add("geocrs:EquidistantCylindricalProjection rdfs:subClassOf geocrs:EquidistantProjection, geocrs:CylindricalProjection .\n")
ttl.add("geocrs:EquidistantConicProjection rdf:type owl:Class .\n")
ttl.add("geocrs:EquidistantConicProjection rdfs:label \"equidistant conic projection\"@en .\n")
ttl.add("geocrs:EquidistantConicProjection rdfs:subClassOf geocrs:EquidistantProjection, geocrs:ConicalProjection .\n")
...
ttl.add("geocrs:ArtificialSatellite rdf:type owl:Class .\n")
ttl.add("geocrs:ArtificialSatellite rdfs:label \"artificial satellite\"@en .\n")
ttl.add("geocrs:ArtificialSatellite rdfs:subClassOf geocrs:InterstellarBody .\n")
...
ttl.add("geocrs:TranslationOperation rdf:type owl:Class .\n")
ttl.add("geocrs:TranslationOperation rdfs:subClassOf geocrs:AffineTransformationOperation .\n")
ttl.add("geocrs:TranslationOperation rdfs:label \"translation transformation operation\"@en .\n")
ttl.add("geocrs:IdentityOperation rdf:type owl:Class .\n")
ttl.add("geocrs:IdentityOperation rdfs:subClassOf geocrs:AffineTransformationOperation .\n")
ttl.add("geocrs:IdentityOperation rdfs:label \"identity transformation operation\"@en .\n")
ttl.add("geocrs:ShearOperation rdf:type owl:Class .\n")
ttl.add("geocrs:ShearOperation rdfs:subClassOf geocrs:AffineTransformationOperation .\n")
ttl.add("geocrs:ShearOperation rdfs:label \"shear transformation operation\"@en .\n")
