...
ttlnoniso.add("geocrs:Projection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:Projection rdfs:label \"projection\"@en .\n")
ttlnoniso.add("geocrs:Projection rdfs:subClassOf geocrs:CoordinateConversionOperation .\n")
ttlnoniso.add("geocrs:Projection skos:definition \"coordinate conversion from an ellipsoidal coordinate system to a plane\"@en .\n")
ttlnoniso.add("geocrs:PerspectiveProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:PerspectiveProjection rdfs:label \"perspective projection\"@en .\n")
ttlnoniso.add("geocrs:PerspectiveProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:EquidistantProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:EquidistantProjection rdfs:label \"equidistant projection\"@en .\n")
ttlnoniso.add("geocrs:EquidistantProjection skos:definition \"Projection in which all points on the map exhibit proportionally correct distances from the center point\"@en .\n")
ttlnoniso.add("geocrs:EquidistantProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:ConformalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:ConformalProjection rdfs:label \"conformal projection\"@en .\n")
ttlnoniso.add("geocrs:ConformalProjection skos:definition \"A projection in which every angle between two curves that crosss each other on a celestical boday is preserved in the image of the projection\"@en .\n")
ttlnoniso.add("geocrs:ConformalProjection rdfs:subClassOf geocrs:Projection .\n")
...
ttlnoniso.add("geocrs:AzimuthalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:AzimuthalProjection rdfs:label \"azimuthal projection\"@en .\n")
ttlnoniso.add("geocrs:AzimuthalProjection skos:definition \"A projection with the property that directions from a central point are preserved\"@en .\n")
ttlnoniso.add("geocrs:AzimuthalProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:RetroazimuthalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:RetroazimuthalProjection rdfs:label \"retroazimuthal projection\"@en .\n")
ttlnoniso.add("geocrs:RetroazimuthalProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:CollignonProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:CollignonProjection rdfs:label \"collignon projection\"@en .\n")
ttlnoniso.add("geocrs:CollignonProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:GaussKruegerProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:GaussKruegerProjection rdfs:label \"gauss-krüger projection\"@en .\n")
ttlnoniso.add("geocrs:GaussKruegerProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:ConformalProjection .\n")
ttlnoniso.add("geocrs:AuthaGraphProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:AuthaGraphProjection rdfs:label \"autha graph projection\"@en .\n")
ttlnoniso.add("geocrs:AuthaGraphProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:ToblerHyperelliptical rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:ToblerHyperelliptical rdfs:label \"tobler hyperelliptical projection\"@en .\n")
ttlnoniso.add("geocrs:ToblerHyperelliptical rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:CahillKeyesProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:CahillKeyesProjection rdfs:label \"cahill-keyes projection\"@en .\n")
ttlnoniso.add("geocrs:CahillKeyesProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:CentralCylindricalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:CentralCylindricalProjection rdfs:label \"central cylindrical projection\"@en .\n")
ttlnoniso.add("geocrs:CentralCylindricalProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:PerspectiveProjection .\n")
ttlnoniso.add("geocrs:LittrowProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:LittrowProjection rdfs:label \"littrow projection\"@en .\n")
ttlnoniso.add("geocrs:LittrowProjection rdfs:subClassOf geocrs:RetroazimuthalProjection, geocrs:ConformalProjection .\n")
ttlnoniso.add("geocrs:QuarticAuthalicProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:QuarticAuthalicProjection rdfs:label \"quartic authalic projection\"@en .\n")
ttlnoniso.add("geocrs:QuarticAuthalicProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:CraigRetroazimuthalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:CraigRetroazimuthalProjection rdfs:label \"craig retroazimuthal projection\"@en .\n")
ttlnoniso.add("geocrs:CraigRetroazimuthalProjection rdfs:subClassOf geocrs:RetroazimuthalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:PeirceQuincuncialProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:PeirceQuincuncialProjection rdfs:label \"peirce quincuncial projection\"@en .\n")
ttlnoniso.add("geocrs:PeirceQuincuncialProjection rdfs:subClassOf geocrs:ConformalProjection .\n")
ttlnoniso.add("geocrs:VerticalPerspectiveProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:VerticalPerspectiveProjection rdfs:label \"vertical perspective projection\"@en .\n")
ttlnoniso.add("geocrs:VerticalPerspectiveProjection rdfs:subClassOf geocrs:AzimuthalProjection, geocrs:PerspectiveProjection .\n")
ttlnoniso.add("geocrs:NicolosiGlobularProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:NicolosiGlobularProjection rdfs:label \"nicolosi globular projection\"@en .\n")
ttlnoniso.add("geocrs:NicolosiGlobularProjection rdfs:subClassOf geocrs:PseudoConicalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:BehrmannProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:BehrmannProjection rdfs:label \"behrmann projection\"@en .\n")
ttlnoniso.add("geocrs:BehrmannProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:HoboDyerProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:HoboDyerProjection rdfs:label \"hobo-dyer projection\"@en .\n")
ttlnoniso.add("geocrs:HoboDyerProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:GallPetersProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:GallPetersProjection rdfs:label \"gall-peters projection\"@en .\n")
ttlnoniso.add("geocrs:GallPetersProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:GallStereographicProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:GallStereographicProjection rdfs:label \"gall stereographic projection\"@en .\n")
ttlnoniso.add("geocrs:GallStereographicProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:Strebe1995Projection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:Strebe1995Projection rdfs:label \"strebe 1995 projection\"@en .\n")
ttlnoniso.add("geocrs:Strebe1995Projection rdfs:subClassOf geocrs:PseudoAzimuthalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:WatermanButterflyProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:WatermanButterflyProjection rdfs:label \"waterman butterfly projection\"@en .\n")
ttlnoniso.add("geocrs:WatermanButterflyProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:QuadrilateralizedSphericalCubeProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:QuadrilateralizedSphericalCubeProjection rdfs:label \"quadrilateralized spherical cube projection\"@en .\n")
ttlnoniso.add("geocrs:QuadrilateralizedSphericalCubeProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:BonneProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:BonneProjection rdfs:label \"bonne projection\"@en .\n")
ttlnoniso.add("geocrs:BonneProjection rdfs:subClassOf geocrs:PseudoConicalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:ArmadilloProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:ArmadilloProjection rdfs:label \"armadillo projection\"@en .\n")
ttlnoniso.add("geocrs:ArmadilloProjection rdfs:subClassOf geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:GS50Projection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:GS50Projection rdfs:label \"gs50 projection\"@en .\n")
ttlnoniso.add("geocrs:GS50Projection rdfs:subClassOf geocrs:ConformalProjection .\n")
ttlnoniso.add("geocrs:Eckert2Projection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:Eckert2Projection rdfs:label \"Eckert II projection\"@en .\n")
ttlnoniso.add("geocrs:Eckert2Projection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:Eckert4Projection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:Eckert4Projection rdfs:label \"Eckert IV projection\"@en .\n")
ttlnoniso.add("geocrs:Eckert4Projection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:Eckert6Projection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:Eckert6Projection rdfs:label \"Eckert VI projection\"@en .\n")
ttlnoniso.add("geocrs:Eckert6Projection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:Kavrayskiy7Projection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:Kavrayskiy7Projection rdfs:label \"Kavrayskiy VII projection\"@en .\n")
ttlnoniso.add("geocrs:Kavrayskiy7Projection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:GuyouProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:GuyouProjection rdfs:label \"guyou projection\"@en .\n")
ttlnoniso.add("geocrs:GuyouProjection rdfs:subClassOf geocrs:ConformalProjection .\n")
ttlnoniso.add("geocrs:RoussilheProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:RoussilheProjection rdfs:label \"roussilhe projection\"@en .\n")
ttlnoniso.add("geocrs:RoussilheProjection rdfs:subClassOf geocrs:ObliqueProjection, geocrs:StereographicProjection .\n")
ttlnoniso.add("geocrs:LeeProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:LeeProjection rdfs:label \"lee projection\"@en .\n")
ttlnoniso.add("geocrs:LeeProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:ConformalProjection .\n")
ttlnoniso.add("geocrs:AdamsProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:AdamsProjection rdfs:label \"adams projection\"@en .\n")
ttlnoniso.add("geocrs:AdamsProjection rdfs:subClassOf geocrs:ConformalProjection .\n")
ttlnoniso.add("geocrs:OrteliusOvalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:OrteliusOvalProjection rdfs:label \"ortelius oval projection\"@en .\n")
ttlnoniso.add("geocrs:OrteliusOvalProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:GoodeHomolosineProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:GoodeHomolosineProjection rdfs:label \"goode homolosine projection\"@en .\n")
ttlnoniso.add("geocrs:GoodeHomolosineProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:HEALPixProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:HEALPixProjection rdfs:label \"HEALPix projection\"@en .\n")
ttlnoniso.add("geocrs:HEALPixProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:BoggsEumorphicProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:BoggsEumorphicProjection rdfs:label \"boggs eumorphic projection\"@en .\n")
ttlnoniso.add("geocrs:BoggsEumorphicProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:CrasterParabolicProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:CrasterParabolicProjection rdfs:label \"craster parabolic projection\"@en .\n")
ttlnoniso.add("geocrs:CrasterParabolicProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:TheTimesProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:TheTimesProjection rdfs:label \"the times projection\"@en .\n")
ttlnoniso.add("geocrs:TheTimesProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:DymaxionProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:DymaxionProjection rdfs:label \"dymaxion projection\"@en .\n")
ttlnoniso.add("geocrs:DymaxionProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:MollweideProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:MollweideProjection rdfs:label \"mollweide projection\"@en .\n")
ttlnoniso.add("geocrs:MollweideProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:MyrahedalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:MyrahedalProjection rdfs:label \"myrahedal projection\"@en .\n")
ttlnoniso.add("geocrs:MyrahedalProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:WagnerVIIProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:WagnerVIIProjection rdfs:label \"wagner VII projection\"@en .\n")
ttlnoniso.add("geocrs:WagnerVIIProjection rdfs:subClassOf geocrs:PseudoAzimuthalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:AtlantisProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:AtlantisProjection rdfs:label \"atlantis projection\"@en .\n")
ttlnoniso.add("geocrs:AtlantisProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:BertinProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:BertinProjection rdfs:label \"bertin projection\"@en .\n")
ttlnoniso.add("geocrs:BertinProjection rdfs:subClassOf geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:WernerProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:WernerProjection rdfs:label \"werner projection\"@en .\n")
ttlnoniso.add("geocrs:WernerProjection rdfs:subClassOf geocrs:PseudoConicalProjection, geocrs:EqualAreaProjection, geocrs:EquidistantProjection .\n")
ttlnoniso.add("geocrs:EquirectangularProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:EquirectangularProjection rdfs:label \"equirectangular projection\"@en .\n")
ttlnoniso.add("geocrs:EquirectangularProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:EquidistantProjection .\n")
ttlnoniso.add("geocrs:ConicalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:ConicalProjection rdfs:label \"conical projection\"@en .\n")
ttlnoniso.add("geocrs:ConicalProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:ObliqueMercatorProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:ObliqueMercatorProjection rdfs:label \"oblique mercator projection\"@en .\n")
ttlnoniso.add("geocrs:ObliqueMercatorProjection rdfs:subClassOf geocrs:MercatorProjection, geocrs:CylindricalProjection, geocrs:ObliqueProjection .\n")
ttlnoniso.add("geocrs:SpaceObliqueMercatorProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:SpaceObliqueMercatorProjection rdfs:label \"space oblique mercator projection\"@en .\n")
ttlnoniso.add("geocrs:SpaceObliqueMercatorProjection rdfs:subClassOf geocrs:ObliqueMercatorProjection .\n")
ttlnoniso.add("geocrs:PolyhedralProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:PolyhedralProjection rdfs:label \"polyhedral projection\"@en .\n")
ttlnoniso.add("geocrs:PolyhedralProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:PseudoCylindricalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:PseudoCylindricalProjection rdfs:label \"pseudo-cylindrical projection\"@en .\n")
ttlnoniso.add("geocrs:PseudoCylindricalProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:PseudoAzimuthalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:PseudoAzimuthalProjection rdfs:label \"pseudo-azimuthal projection\"@en .\n")
ttlnoniso.add("geocrs:PseudoAzimuthalProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:CylindricalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:CylindricalProjection rdfs:label \"cylindrical projection\"@en .\n")
ttlnoniso.add("geocrs:CylindricalProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:EqualAreaProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:EqualAreaProjection rdfs:label \"equal-area projection\"@en .\n")
ttlnoniso.add("geocrs:EqualAreaProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:AmericanPolyconicProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:AmericanPolyconicProjection  rdfs:label \"american polyconic projection\"@en .\n")
ttlnoniso.add("geocrs:AmericanPolyconicProjection  rdfs:subClassOf geocrs:PseudoConicalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:RectangularPolyconicProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:RectangularPolyconicProjection  rdfs:label \"rectangular polyconic projection\"@en .\n")
ttlnoniso.add("geocrs:RectangularPolyconicProjection  rdfs:subClassOf geocrs:PseudoConicalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:ObliqueProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:ObliqueProjection rdfs:label \"oblique projection\"@en .\n")
ttlnoniso.add("geocrs:ObliqueProjection skos:definition \"a projection made by parallel lines drawn from every point of a figure and meeting the plane of projection obliquely\"@en .\n")
ttlnoniso.add("geocrs:ObliqueProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:LoximuthalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:LoximuthalProjection rdfs:label \"loximuthal projection\"@en .\n")
ttlnoniso.add("geocrs:LoximuthalProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:AlbersEqualAreaProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:AlbersEqualAreaProjection rdfs:label \"albers equal-area projection\"@en .\n")
ttlnoniso.add("geocrs:AlbersEqualAreaProjection skos:definition \"a conic, equal area map projection that uses two standard parallels\"@en .\n")
ttlnoniso.add("geocrs:AlbersEqualAreaProjection rdfs:subClassOf geocrs:EqualAreaProjection, geocrs:ConicalProjection .\n")
ttlnoniso.add("geocrs:WinkelTripelProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:WinkelTripelProjection rdfs:label \"winkel tripel projection\"@en .\n")
ttlnoniso.add("geocrs:WinkelTripelProjection rdfs:subClassOf geocrs:PseudoAzimuthalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:OctantProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:OctantProjection rdfs:label \"octant projection\"@en .\n")
ttlnoniso.add("geocrs:OctantProjection rdfs:subClassOf geocrs:PolyhedralProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:EqualEarthProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:EqualEarthProjection rdfs:label \"equal earth projection\"@en .\n")
ttlnoniso.add("geocrs:EqualEarthProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:NaturalEarthProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:NaturalEarthProjection rdfs:label \"natural earth projection\"@en .\n")
ttlnoniso.add("geocrs:NaturalEarthProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:OrthographicProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:OrthographicProjection rdfs:label \"orthographic projection\"@en .\n")
ttlnoniso.add("geocrs:OrthographicProjection rdfs:subClassOf geocrs:AzimuthalProjection, geocrs:PerspectiveProjection .\n")
ttlnoniso.add("geocrs:LabordeProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:LabordeProjection rdfs:label \"laborde projection\"@en .\n")
ttlnoniso.add("geocrs:LabordeProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:ConformalProjection .\n")
ttlnoniso.add("geocrs:GnomonicProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:GnomonicProjection rdfs:label \"gnomonic projection\"@en .\n")
ttlnoniso.add("geocrs:GnomonicProjection rdfs:subClassOf geocrs:AzimuthalProjection .\n")
ttlnoniso.add("geocrs:CassiniProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:CassiniProjection rdfs:label \"cassini projection\"@en .\n")
ttlnoniso.add("geocrs:CassiniProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:EquidistantProjection .\n")
ttlnoniso.add("geocrs:AitoffProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:AitoffProjection rdfs:label \"aitoff projection\"@en .\n")
ttlnoniso.add("geocrs:AitoffProjection rdfs:subClassOf geocrs:PseudoAzimuthalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:CompromiseProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:CompromiseProjection rdfs:label \"compromise projection\"@en .\n")
ttlnoniso.add("geocrs:CompromiseProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:HammerProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:HammerProjection rdfs:label \"hammer projection\"@en .\n")
ttlnoniso.add("geocrs:HammerProjection rdfs:subClassOf geocrs:PseudoAzimuthalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:TwoPointEquidistantProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:TwoPointEquidistantProjection rdfs:label \"two-point equidistance projection\"@en .\n")
ttlnoniso.add("geocrs:TwoPointEquidistantProjection rdfs:subClassOf geocrs:AzimuthalProjection, geocrs:EquidistantProjection .\n")
ttlnoniso.add("geocrs:SinusoidalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:SinusoidalProjection rdfs:label \"sinusoidal projection\"@en .\n")
ttlnoniso.add("geocrs:SinusoidalProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:EqualAreaProjection, geocrs:EquidistantProjection .\n")
ttlnoniso.add("geocrs:PseudoConicalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:PseudoConicalProjection rdfs:label \"pseudo-conical projection\"@en .\n")
ttlnoniso.add("geocrs:PseudoConicalProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:ColombiaUrbanProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:ColombiaUrbanProjection rdfs:label \"colombia urban projection\"@en .\n")
ttlnoniso.add("geocrs:ColombiaUrbanProjection rdfs:subClassOf geocrs:Projection .\n")
ttlnoniso.add("geocrs:StereographicProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:StereographicProjection rdfs:label \"stereographic projection\"@en .\n")
ttlnoniso.add("geocrs:StereographicProjection skos:definition \"A projection which can be constructed using the tangent's points antipoide as the point of perspective\"@en .\n")
ttlnoniso.add("geocrs:StereographicProjection rdfs:subClassOf geocrs:ConformalProjection, geocrs:AzimuthalProjection .\n")
ttlnoniso.add("geocrs:ObliqueStereographicProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:ObliqueStereographicProjection rdfs:label \"oblique stereographic projection\"@en .\n")
ttlnoniso.add("geocrs:ObliqueStereographicProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:ObliqueProjection .\n")
ttlnoniso.add("geocrs:MercatorProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:MercatorProjection rdfs:label \"mercator projection\"@en .\n")
ttlnoniso.add("geocrs:MercatorProjection rdfs:subClassOf geocrs:ConformalProjection, geocrs:CylindricalProjection .\n")
ttlnoniso.add("geocrs:BottomleyProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:BottomleyProjection rdfs:label \"bottomley projection\"@en .\n")
ttlnoniso.add("geocrs:BottomleyProjection rdfs:subClassOf geocrs:PseudoConicalProjection, geocrs:EqualAreaProjection .\n")
ttlnoniso.add("geocrs:VanDerGrintenProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:VanDerGrintenProjection rdfs:label \"van der grinten projection\"@en .\n")
ttlnoniso.add("geocrs:VanDerGrintenProjection rdfs:subClassOf geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:RobinsonProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:RobinsonProjection rdfs:label \"robinson projection\"@en .\n")
ttlnoniso.add("geocrs:RobinsonProjection rdfs:subClassOf geocrs:PseudoCylindricalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:WebMercatorProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:WebMercatorProjection rdfs:label \"web mercator projection\"@en .\n")
ttlnoniso.add("geocrs:WebMercatorProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:MillerProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:MillerProjection rdfs:label \"miller projection\"@en .\n")
ttlnoniso.add("geocrs:MillerProjection rdfs:subClassOf geocrs:CylindricalProjection, geocrs:CompromiseProjection .\n")
ttlnoniso.add("geocrs:Krovak rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:Krovak rdfs:label \"krovak projection\"@en .\n")
ttlnoniso.add("geocrs:Krovak rdfs:subClassOf geocrs:ConicalProjection .\n")
ttlnoniso.add("geocrs:TransverseMercatorProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:TransverseMercatorProjection rdfs:label \"transverse mercator projection\"@en .\n")
ttlnoniso.add("geocrs:TransverseMercatorProjection rdfs:subClassOf geocrs:MercatorProjection .\n")
ttlnoniso.add("geocrs:UniversalTransverseMercatorProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:UniversalTransverseMercatorProjection rdfs:label \"universal transverse mercator projection\"@en .\n")
ttlnoniso.add("geocrs:UniversalTransverseMercatorProjection rdfs:subClassOf geocrs:TransverseMercatorProjection .\n")
ttlnoniso.add("geocrs:LambertConformalConicProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:LambertConformalConicProjection rdfs:label \"lambert conformal conic projection\"@en .\n")
ttlnoniso.add("geocrs:LambertConformalConicProjection rdfs:subClassOf geocrs:ConformalProjection, geocrs:ConicalProjection .\n")
ttlnoniso.add("geocrs:CylindricalEqualArea rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:CylindricalEqualArea rdfs:label \"cylindrical equal area projection\"@en .\n")
ttlnoniso.add("geocrs:CylindricalEqualArea rdfs:subClassOf geocrs:EqualAreaProjection, geocrs:CylindricalProjection .\n")
ttlnoniso.add("geocrs:LambertAzimuthalEqualArea rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:LambertAzimuthalEqualArea rdfs:label \"lambert azimuthal equal area projection\"@en .\n")
ttlnoniso.add("geocrs:LambertAzimuthalEqualArea rdfs:subClassOf geocrs:EqualAreaProjection, geocrs:AzimuthalProjection .\n")
ttlnoniso.add("geocrs:EquidistantCylindricalProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:EquidistantCylindricalProjection rdfs:label \"equidistant cylindrical projection\"@en .\n")
ttlnoniso.add("geocrs:EquidistantCylindricalProjection rdfs:subClassOf geocrs:EquidistantProjection, geocrs:CylindricalProjection .\n")
ttlnoniso.add("geocrs:EquidistantConicProjection rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:EquidistantConicProjection rdfs:label \"equidistant conic projection\"@en .\n")
ttlnoniso.add("geocrs:EquidistantConicProjection rdfs:subClassOf geocrs:EquidistantProjection, geocrs:ConicalProjection .\n")
...
ttl.add("geocrs:AffineTransformationOperation rdf:type owl:Class .\n")
ttl.add("geocrs:AffineTransformationOperation rdfs:subClassOf geocrs:CoordinateTransformationOperation .\n")
ttl.add("geocrs:AffineTransformationOperation rdfs:label \"affine coordinate transformation operation\"@en .\n")
ttl.add("geocrs:ReflectionOperation rdf:type owl:Class .\n")
ttl.add("geocrs:ReflectionOperation rdfs:subClassOf geocrs:AffineTransformationOperation .\n")
...
ttlnoniso.add("geocrs:InterstellarBody rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:InterstellarBody rdfs:label \"interstellar body\"@en .\n")
ttlnoniso.add("geocrs:Planet rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:Planet rdfs:label \"planet\"@en .\n")
ttlnoniso.add("geocrs:Planet rdfs:subClassOf geocrs:InterstellarBody .\n")
ttlnoniso.add("geocrs:DwarfPlanet rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:DwarfPlanet rdfs:label \"dwarf planet\"@en .\n")
ttlnoniso.add("geocrs:DwarfPlanet rdfs:subClassOf geocrs:Planet .\n")
ttlnoniso.add("geocrs:Plutoid rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:Plutoid rdfs:label \"plutoid\"@en .\n")
ttlnoniso.add("geocrs:Plutoid rdfs:subClassOf geocrs:DwarfPlanet .\n")
ttlnoniso.add("geocrs:NaturalSatellite rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:NaturalSatellite rdfs:label \"natural satellite\"@en .\n")
ttlnoniso.add("geocrs:NaturalSatellite skos:definition \"an interstellar body orbiting around another interstellar body\"@en .\n")
ttlnoniso.add("geocrs:NaturalSatellite rdfs:subClassOf geocrs:InterstellarBody .\n")
ttlnoniso.add("geocrs:Star rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:Star rdfs:label \"star\"@en .\n")
ttlnoniso.add("geocrs:Star rdfs:subClassOf geocrs:InterstellarBody .\n")
ttlnoniso.add("geocrs:Moon rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:Moon rdfs:label \"moon\"@en .\n")
ttlnoniso.add("geocrs:Moon rdfs:subClassOf geocrs:NaturalSatellite .\n")
ttlnoniso.add("geocrs:Comet rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:Comet rdfs:label \"comet\"@en .\n")
ttlnoniso.add("geocrs:Comet rdfs:subClassOf geocrs:InterstellarBody .\n")
ttlnoniso.add("geocrs:ArtificialSatellite rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:ArtificialSatellite rdfs:label \"artificial satellite\"@en .\n")
ttlnoniso.add("geocrs:ArtificialSatellite rdfs:subClassOf geocrs:InterstellarBody .\n")
ttlnoniso.add("geocrs:Asteroid rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:Asteroid rdfs:label \"asteroid\"@en .\n")
ttlnoniso.add("geocrs:Asteroid rdfs:subClassOf geocrs:InterstellarBody .\n")
ttlnoniso.add("geocrs:RotationOperation rdf:type owl:Class .\n")
ttlnoniso.add("geocrs:RotationOperation rdfs:subClassOf geocrs:AffineTransformationOperation .\n")
...
ttlnoniso.add("geocrs:TranslationOperation rdfs:subClassOf geocrs:AffineTransformationOperation .\n")
...
ttlnoniso.add("geocrs:IdentityOperation rdfs:subClassOf geocrs:AffineTransformationOperation .\n")
...
ttlnoniso.add("geocrs:ShearOperation rdfs:subClassOf geocrs:AffineTransformationOperation .\n")
...
"""ttlnoniso.add("geocrs:north rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:north rdfs:label \"north\"@en .\n")
ttlnoniso.add("geocrs:north skos:definition \"axis positive direction is north\"@en .\n")
ttlnoniso.add("geocrs:north rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:north_north_east rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:north_north_east rdfs:label \"north-north-east\"@en .\n")
ttlnoniso.add("geocrs:north_north_east skos:definition \"axis positive direction is approximately north-north-east\"@en .\n")
ttlnoniso.add("geocrs:north_north_east rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:north_east rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:north_east rdfs:label \"north-east\"@en .\n")
ttlnoniso.add("geocrs:north_east skos:definition \"axis positive direction is approximately north-east\"@en .\n")
ttlnoniso.add("geocrs:north_east rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:east_north_east rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:east_north_east rdfs:label \"east-north-east\"@en .\n")
ttlnoniso.add("geocrs:east_north_east rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:east_north_east skos:definition \"axis positive direction is approximately east-north-east\"@en .\n")
ttlnoniso.add("geocrs:east rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:east rdfs:label \"east\"@en .\n")
ttlnoniso.add("geocrs:east rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:east skos:definition \"axis positive direction is p/2 radians clockwise from north\"@en .\n")
ttlnoniso.add("geocrs:east_south_east rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:east_south_east rdfs:label \"east-south-east\"@en .\n")
ttlnoniso.add("geocrs:east_south_east rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:east_south_east skos:definition \"axis positive direction is approximately east-south-east\"@en .\n")
ttlnoniso.add("geocrs:south_east rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:south_east rdfs:label \"south-east\"@en .\n")
ttlnoniso.add("geocrs:south_east rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:south_east skos:definition \"axis positive direction is approximately south-east\"@en .\n")
ttlnoniso.add("geocrs:south_south_east rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:south_south_east rdfs:label \"south-south-east\"@en .\n")
ttlnoniso.add("geocrs:south_south_east rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:south_south_east skos:definition \"axis positive direction is approximately south-south-east\"@en .\n")
ttlnoniso.add("geocrs:south rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:south rdfs:label \"south\"@en .\n")
ttlnoniso.add("geocrs:south rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:south skos:definition \"axis positive direction is p radians clockwise from north\"@en .\n")
ttlnoniso.add("geocrs:south_south_west rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:south_south_west rdfs:label \"south-south-west\"@en .\n")
ttlnoniso.add("geocrs:south_south_west rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:south_south_west skos:definition \"axis positive direction is approximately south-south-west\"@en .\n")
ttlnoniso.add("geocrs:south_west rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:south_west rdfs:label \"south-west\"@en .\n")
ttlnoniso.add("geocrs:south_west rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:south_west skos:definition \"axis positive direction is approximately south-west\"@en .\n")
ttlnoniso.add("geocrs:west_south_west rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:west_south_west rdfs:label \"west-south-west\"@en .\n")
ttlnoniso.add("geocrs:west_south_west rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:west_south_west skos:definition \"axis positive direction is approximately west-south-west\"@en .\n")
ttlnoniso.add("geocrs:west rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:west rdfs:label \"west\"@en .\n")
ttlnoniso.add("geocrs:west rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:west skos:definition \"axis positive direction is 3p/2 radians clockwise from north\"@en .\n")
ttlnoniso.add("geocrs:west_north_west rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:west_north_west rdfs:label \"west-north-west\"@en .\n")
ttlnoniso.add("geocrs:west_north_west rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:west_north_west skos:definition \"axis positive direction is approximately west-north-west\"@en .\n")
ttlnoniso.add("geocrs:north_west rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:north_west rdfs:label \"north-west\"@en .\n")
ttlnoniso.add("geocrs:north_west rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:north_west skos:definition \"axis positive direction is approximately north-west\"@en .\n")
ttlnoniso.add("geocrs:north_north_west rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:north_north_west rdfs:label \"north-north-west\"@en .\n")
ttlnoniso.add("geocrs:north_north_west skos:definition \"axis positive direction is approximately north-north-west\"@en .\n")
ttlnoniso.add("geocrs:north_north_west rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:up rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:up rdfs:label \"up\"@en .\n")
ttlnoniso.add("geocrs:up rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:up skos:definition \"axis positive direction is up relative to gravity\"@en .\n")
ttlnoniso.add("geocrs:down rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:down rdfs:label \"down\"@en .\n")
ttlnoniso.add("geocrs:down rdfs:isDefinedBy <http://docs.opengeospatial.org/as/18-005r4/18-005r4.html> .\n")
ttlnoniso.add("geocrs:down skos:definition \"axis positive direction is down relative to gravity\"@en .\n")
ttlnoniso.add("geocrs:geocentricX rdf:type geocrs:AxisDirection, owl:NamedIndividual  .\n")
ttlnoniso.add("geocrs:geocentricX rdfs:label \"geocentric X\"@en .\n")
...
ttlnoniso.add("geocrs:satelliteOf rdf:type owl:ObjectProperty .\n")
ttlnoniso.add("geocrs:satelliteOf rdfs:label \"satellite of\"@en .\n")
ttlnoniso.add("geocrs:satelliteOf skos:definition \"Defines an interstellar body as the natural satellite of another interstellar body.\"@en .\n")
ttlnoniso.add("geocrs:satelliteOf rdfs:domain geocrs:InterstellarBody .\n")
ttlnoniso.add("geocrs:satelliteOf rdfs:range geocrs:InterstellarBody .\n")
ttlnoniso.add("geocrs:planet_status rdf:type owl:ObjectProperty .\n")
ttlnoniso.add("geocrs:planet_status rdfs:label \"planet status\"@en .\n")
ttlnoniso.add("geocrs:planet_status skos:definition \"The status of the discovery of the planet, e.g. confirmed, unsure etc.\"@en .\n")
ttlnoniso.add("geocrs:planet_status rdfs:domain geocrs:InterstellarBody .\n")
ttlnoniso.add("geocrs:planet_status rdfs:range geocrs:PlanetStatus .\n")
...
ttlnoniso.add("geocrs:area_of_use rdfs:domain geocrs:CoordinateConcatenatedOperation, geocrs:CoordinateConversionOperation, geocrs:CoordinateTransformationOperation, geocrs:OtherCoordinateOperation, geocrs:CoordinateOperation .\n")
...
graph = Graph()
graph.parse(data = ttlhead+"".join(ttlnoniso), format='turtle')
graph.parse("iso_combined_srsnamespace.ttl",format='turtle')
...
graph2.parse("iso_combined_srsnamespace.ttl",format='turtle')
